-- Rename associate a2 (Priya -> Moustapha). reset_demo() re-seeds associates, so it's
-- redefined with the new name; it keeps running as definer (see 20260925020000).

update public.associates set name = 'Moustapha' where id = 'a2';
...
begin
  ...
  values
    ...
    ('a2', 'Moustapha', array['bopis', 'customer'], 'Pickup desk'),
